...
This work performs genome based computational analyses covering assembly QC, annotation transfer, orthology inference, functional annotation, and result integration to map PR25 gene origin and dominant functional signals.
Scope excludes variant calling and wet lab validation.

## Objectives
1. Classify PR25 genes into RD23_only, OL_only, and BOTH using ortholog evidence against RD23 and *O. longistaminata*.
...
## Publication
This research has been published in *Edumatic: Jurnal Pendidikan Informatika*:

> **Orthology-Based Reconstruction of Parental Gene Inheritance in the Chromosome-Scale PR25 Perennial Rice Genome**  
> Napitupulu, M.B., Pardede, C., & Siagian, P. (2026). *Edumatic: Jurnal Pendidikan Informatika*, 10(2), 440–449.  
> **DOI:** [10.29408/edumatic.v10i2.36252](https://doi.org/10.29408/edumatic.v10i2.36252)
